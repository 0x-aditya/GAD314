...
namespace _Main.Scripts.Farming
{
    ...
    public class FarmLand : MonoBehaviour
    {
        ...
        [SerializeField] private Sprite plantedLandSprite;
        [SerializeField] private Sprite growingLandSprite;
        [SerializeField] private Sprite readyToHarvestLandSprite;
        ...
        private void Harvest()
        {
            ...
            PlayerStats.instance.AddWheat(1);
        ...
        private void Update()
        {
            if (currentState == LandState.Empty || currentState == LandState.ReadyToHarvest || _isGrowing) return;
